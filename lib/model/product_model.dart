...
List<ProductModel> responseModelFromJson(String str) => List<ProductModel>.from(
    json.decode(str).map((x) => ProductModel.fromJson(x)));

String responseModelToJson(List<ProductModel> data) =>
...
class ProductModel {
  ...
  late String productApiUrl;
  late String apiFeaturedImage;
